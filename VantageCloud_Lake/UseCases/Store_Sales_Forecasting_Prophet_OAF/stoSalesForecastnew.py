...
#     print(row['ds'])
# for ind, column in enumerate(forecast_df.columns):
#     print(column)
for index, row in forecast_df.iterrows():
    print(row['ds'], delimiter, row['yhat'], delimiter,row['yhat_lower'], delimiter, row['yhat_upper'], delimiter, row['trend'], delimiter, row['trend_lower'], delimiter, row['trend_upper'])
