...
replace view TRNG_DS.Orders as locking row for access select * from  gs_tables_db."TRNG_DS_Orders";
replace view TRNG_DS.Orders_1600 as locking row for access select * from  gs_tables_db."TRNG_DS_Orders_1600";
replace view TRNG_DS.Orders_2021 as locking row for access select * from  gs_tables_db."TRNG_DS_Orders_2021";
