create database TRNG_ParkinsonsDisease from Demo_User as perm=0;
create foreign table gs_tables_db."TRNG_ParkinsonsDisease_pd_speech_features", external security gs_tables_db.auth using (location('/gs/storage.googleapis.com/demonow_development/ParkinsonsDisease/Speech_Data/'));
replace view TRNG_ParkinsonsDisease.pd_speech_features as locking row for access select
      id ,
      gender ,
      PPE ,
      DFA ,
      ...
      tqwt_TKEO_mean_dec_20 ,
      tqwt_TKEO_mean_dec_21 ,
      tqwt_TKEO_mean_dec_22 ,
      tqwt_TKEO_mean_dec_23 ,
      tqwt_TKEO_mean_dec_24 ,
      ...
      "class"
from gs_tables_db.TRNG_ParkinsonsDisease_pd_speech_features;
