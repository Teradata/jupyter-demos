create database TRNG_IndoorSensor from demonow as perm=0;
...
replace view TRNG_IndoorSensor.connectivity as locking row for access select * from  gs_tables_db."TRNG_IndoorSensor_connectivity";
replace view TRNG_IndoorSensor.sensor_locations as locking row for access select * from  gs_tables_db."TRNG_IndoorSensor_sensor_locations";
