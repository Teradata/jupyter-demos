...
replace view TRNG_LondonTube.Art_Centers as locking row for access select * from  gs_tables_db."TRNG_LondonTube_Art_Centers";
replace view TRNG_LondonTube.Cinemas as locking row for access select * from  gs_tables_db."TRNG_LondonTube_Cinemas";
replace view TRNG_LondonTube.Museums as locking row for access select * from  gs_tables_db."TRNG_LondonTube_Museums";
replace view TRNG_LondonTube.Theatres as locking row for access select * from  gs_tables_db."TRNG_LondonTube_Theatres";
replace view TRNG_LondonTube.TubeLines as locking row for access select * from  gs_tables_db."TRNG_LondonTube_TubeLines";
replace view TRNG_LondonTube.TubeStations as locking row for access select * from  gs_tables_db."TRNG_LondonTube_TubeStations";
replace view TRNG_LondonTube.dance_performance as locking row for access select * from  gs_tables_db."TRNG_LondonTube_dance_performance";
replace view TRNG_LondonTube.stepFree_NN as locking row for access select * from  gs_tables_db."TRNG_LondonTube_stepFree_NN";
